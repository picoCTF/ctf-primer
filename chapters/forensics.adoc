//Forensics outline from Textbook0 Google Doc on shared CyLab Academy drive
...
to the CyLab Academy webshell at:

https://webshell.cylabacademy.org/

Once you are connected, open up this problem in a separate tab:

https://learn.cylabacademy.org/library/85
...
[source, text]
$ wget https://jupiter.challenges.cylabacademy.org/static/495d43ee4a2b9f345a4307d053b4d88d/file
...
https://learn.cylabacademy.org/library/320
...
this Challenge Library problem, which presents the first step in analyzing disk images:
...
* `saturn.picoctf.net` This is the name of the computer we're connecting to.
  This is a challenge server that CyLab Academy runs.
...
So go ahead and solve your first Sleuthkit problem in the Challenge Library and learn the
...
https://learn.cylabacademy.org/library/300
...
First off, download the challenge file. Remember the technique we learned
earlier. The link will be different, and you have to right click on the link
in the description to get it:
...
https://learn.cylabacademy.org/library/137

If you want to use what you know to dive even deeper into a disk, try this
problem:

https://learn.cylabacademy.org/library/285
...
Consider this CyLab Academy challenge:
