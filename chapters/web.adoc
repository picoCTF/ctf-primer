...
https://primer.cylabacademy.org/vuln/web/sign_up.php[https://primer.cylabacademy.org/vuln/web/sign_up.php, window="_blank"]

Open another tab and visit the following link. You should see your name and description:

https://primer.cylabacademy.org/vuln/web/tableusers.php[https://primer.cylabacademy.org/vuln/web/tableusers.php, window="_blank"]
...
<script>
$.get(
    "https://primer.cylabacademy.org/vuln/web/insert.php",
...
https://primer.cylabacademy.org/vuln/web/tablestolen.php[https://primer.cylabacademy.org/vuln/web/tablestolen.php, window="_blank"]

[.text-center]
.Table showing results
image::images/image21.png[image,width=624,height=380]

At this point you should have some understanding on how a website works. You are ready to begin to do more web challenges on the CyLab Academy!
