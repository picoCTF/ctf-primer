...
You can get started with Git locally, on your computer, or remotely in the cloud like with the CyLab Academy webshell: 

https://webshell.cylabacademy.org[https://webshell.cylabacademy.org, window="_blank"]
...
This has already been done for you in the CyLab Academy webshell, and can be verified by typing ``git --version``.
...
As a collaboration tool, GitHub allows you to create public 'open source' repositories and join discussions or contribute code to others. You can even find the code for CyLab Academy and add to this primer! https://github.com/picoCTF[https://github.com/picoCTF, window="_blank"]
