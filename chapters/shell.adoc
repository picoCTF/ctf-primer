...
For this reason, I advise you to create a CyLab Academy account at this point
if you have not already. Beyond providing 500+ security challenges in helpful
learning ramps, every CyLab Academy account gets access to a web-based Linux
_shell_.
...
.. Register for a CyLab Academy account
  * Click link in email that is sent to registered email address
... Log in to the CyLab Academy webshell

==== Step by Step Walkthrough
//TODO punt : turn bold text into hyperlinks in this section
*Register for a CyLab Academy account at the link below.* You will need to
...
*Use the same  user name and password that you registered on the CyLab Academy
website to log into the shell at the link below* (or in the "Webshell" panel
on the CyLab Academy website) For the sake of security, you will not see your password
as you type it in.
...
their typing in the shell command prompt until thousands of CTF points into
...
==== Challenge Library Problem

Try out your new shell skills with this challenge from the Challenge Library:

https://learn.cylabacademy.org/library/189
